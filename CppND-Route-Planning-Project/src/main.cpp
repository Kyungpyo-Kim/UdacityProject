...
int main(int argc, const char **argv) {
  ...
  // TODO 1 The user input to the RoutePlanner object
  float start_x, start_y, end_x, end_y;
  std::cout << "\nEnter start_x, start_y, end_x, end_y:\n";
  std::cout << "\bstart_x: ";
  std::cin >> start_x;
  std::cout << "\bstart_y: ";
  std::cin >> start_y;
  ...
  std::cin >> end_y;
  std::cout << "\nYour input\n";
  std::cout << "\bstart_x: " << start_x << "\n";
  std::cout << "\bstart_y: " << start_y << "\n";
  std::cout << "\bend_x: " << end_x << "\n";
  std::cout << "\bend_y: " << end_y << "\n\n";
